...
import { faToggleOn, faToggleOff, faCircleInfo } from '@fortawesome/free-solid-svg-icons';
import '../App.css'
import '../widgets/DayNightWidget.css'
import './DayNightPanel.css'
import '../mobile.css'
...
function DayNightPanel(){
    ...
    return (
        <div className="canvas">
            ...
            {/* Greeting */}
            <div className="daynight-greeting-large">
                <p>{`Good ${phase}!`}</p>
                <p>{`It's ${timeString} on ${dateString}`}</p>
                <div className='outerDemoBtn'>
                    <p>Demo Mode</p>
                ...
                <p className='infoText' style={{ visibility: infoShown ? 'visible' : 'hidden' }}>
                    This animation changes throughout the day! Toggle on Demo Mode to see the full animation!
                </p>
            </div>
