...
function App() {
  const [isMobile, setIsMobile] = useState<boolean>(window.innerWidth < 670);
  ...
  return (
    <div className="App" style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
      <HomeScreen accessToken={accessToken} isMobile={isMobile} handleUnlock={handleUnlock} themes={themes} currentTheme={currentTheme} setCurrentTheme={setCurrentTheme}/>
      {!isUnlocked && (
        <div
